    ...
    <div className="container lottery-page">
      <div>
        ...
        <div className="content">
          <h1>About WinBulk Lottery</h1>
          <p>
            On creating this revolutionary lottery system. We are committed to
            delivering an exceptional user experience that will leave our
            community members delighted.
          </p>
          <p>
            What makes our lottery system truly special is its uniqueness. In the
          ...
          <p>
            ...
            lottery system is ready to revolutionize the way our community engages
            with lotteries.
          </p>
          <p>
            ...
            every user. Their tireless efforts ensure that our lottery system will
          ...
          <p>
            ...
            exciting new chapter in the world of lotteries, and we can't wait to
            share it with you. Stay tuned for updates and get ready to embark on a
            unique lottery experience like no other.
          </p>
        </div>
      </div>
    </div>
